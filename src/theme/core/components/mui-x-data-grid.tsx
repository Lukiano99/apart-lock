...
export const DataGridExportIcon = ({ ...props }: SvgIconProps) => (
  <SvgIcon sx={{ width: 20, height: 20, ...props.sx }} {...props}>
    ...
    <path fill="currentColor" d="M12.375 20.375a8 8 0 0 0 8-8h-3.75c-.943 0-1.414 0-1.707.293c-.293.293-.293.764-.293 1.707a2.25 2.25 0 0 1-4.5 0c0-.943 0-1.414-.293-1.707c-.293-.293-.764-.293-1.707-.293h-3.75a8 8 0 0 0 8 8" />
  </SvgIcon>
);
...
export const DataGridDensityCompactIcon = ({ ...props }: SvgIconProps) => (
  <SvgIcon sx={{ width: 20, height: 20, ...props.sx }} {...props}>
    <path fill="currentColor" d="M4 15.5q-.425 0-.712-.288T3 14.5V14q0-.425.288-.712T4 13h16q.425 0 .713.288T21 14v.5q0 .425-.288.713T20 15.5zM4 11q-.425 0-.712-.288T3 10v-.5q0-.425.288-.712T4 8.5h16q.425 0 .713.288T21 9.5v.5q0 .425-.288.713T20 11zm0-4.5q-.425 0-.712-.288T3 5.5V5q0-.425.288-.712T4 4h16q.425 0 .713.288T21 5v.5q0 .425-.288.713T20 6.5zM4 20q-.425 0-.712-.288T3 19v-.5q0-.425.288-.712T4 17.5h16q.425 0 .713.288T21 18.5v.5q0 .425-.288.713T20 20z" />
  </SvgIcon>
);
...
export const DataGridDensityStandardIcon = ({ ...props }: SvgIconProps) => (
  <SvgIcon sx={{ width: 20, height: 20, ...props.sx }} {...props}>
    <g fill="none">
      <path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" />
      <path fill="currentColor" d="M21 16v3a2 2 0 0 1-1.85 1.995L19 21H5a2 2 0 0 1-1.995-1.85L3 19v-3zm0-6v4H3v-4zm-2-7a2 2 0 0 1 2 2v3H3V5a2 2 0 0 1 2-2z" />
    </g>
  </SvgIcon>
);
...
const MuiDataGrid: Components<Theme>['MuiDataGrid'] = {
  ...
  defaultProps: {
    slots: {
      columnSortedAscendingIcon: DataGridArrowUpIcon as any,
      columnSortedDescendingIcon: DataGridArrowDownIcon as any,
      columnUnsortedIcon: DataGridArrowUpIcon as any,
      columnMenuIcon: DataGridMoreIcon as any,
      columnMenuSortAscendingIcon: DataGridArrowUpIcon as any,
      columnMenuSortDescendingIcon: DataGridArrowDownIcon as any,
      columnMenuFilterIcon: DataGridFilterIcon as any,
      columnMenuHideIcon: DataGridEyeCloseIcon as any,
      columnMenuManageColumnsIcon: DataGridEyeIcon as any,
      columnSelectorIcon: DataGridEyeIcon as any,
      filterPanelDeleteIcon: DataGridCloseIcon as any,
      openFilterButtonIcon: DataGridFilterIcon as any,
      columnFilteredIcon: DataGridFilterIcon as any,
      densityCompactIcon: DataGridDensityCompactIcon as any,
      densityStandardIcon: DataGridDensityStandardIcon as any,
      densityComfortableIcon: DataGridDensityComfortableIcon as any,
      exportIcon: DataGridExportIcon as any,
      quickFilterIcon: DataGridSearchIcon as any,
      quickFilterClearIcon: DataGridCloseIcon as any,
    },
    slotProps: {
      basePopper: { placement: 'bottom-end' },
      baseChip: { size: 'small' },
      baseSwitch: { size: 'small' },
      baseCheckbox: { size: 'small' } as any,
      baseTextField: { variant: 'outlined', InputLabelProps: { shrink: true } } as any,
      baseSelect: { variant: 'outlined' } as any,
    },
  },
